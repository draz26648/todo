...
//this msg appear when tasks = 0 to make you add tasks
  _noTaskMsg() {
    return Stack(
      children: [
        AnimatedPositioned(
...
//this bottom sheet apear when you pressed on task item to give you some settings like update or delete
